...
uses
  Classes, SysUtils, GestionEcran, GestionTexte, inventaireLogic, personnage;
...
begin
    ...
    for i:=1 to 5 do
      ...
      texteAtemps('Felicitation pour ton ',100, 15);
      texteAtemps(objet,100, 1);
      texteAtemps('   ',500, 0);      //texte vide a temps pour laisser la fenetre ouvert quelques seconds
end;
